...
from feature_extractor.utils import system, get_file_type, do_multiprocess
...
class IDAScript:
    ...
    def remove_leftovers(self, input_fname):
        ...
        # exts = [".id0", ".id1", ".nam", ".til", ".id2",".i64",".idb"]
    ...
    def handle_log(self, input_fname, tmp_fname):
        ...
        if self.log:
            ...
            os.unlink(tmp_fname)
    def remove_done(self, input_fname):
        try:
            os.remove(input_fname+".done")
            os.remove(input_fname+".pickle")
        except:
            pass
    ...
    def run_helper(self, input_fname):
        ...
        print("Processing %s ..." % input_fname)
        ...
        path = ["wine",ida, "-A",  '-P+','-S"{}"'.format(idc_args)]
        ...
        if ret != 0:
            ...
            print("Processing %s Done..." % input_fname)
            return input_fname, True
    ...
    def run(self, input_path):
        ...
        # res = do_multiprocess(self.run_helper, elfs, chunk_size=1)
